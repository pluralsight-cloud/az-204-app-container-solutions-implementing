...
resource deploymentScript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    git clone https://github.com/WayneHoggett-ACG/CRFWishlistService.git
    cd CRFWishlistService
    az acr build --registry $ACR --image crfwishlistservice:v1 .
    '''
